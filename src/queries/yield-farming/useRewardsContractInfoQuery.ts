...
export const useRewardsContractInfo = (
	...
	const price = useSnxjsContractQuery<ethers.utils.BigNumber>(snxjs, 'ExchangeRates', 'rateForCurrency', [
		snxjs.toBytes32(fromToken),
	]);

	const SNXPrice = useSnxjsContractQuery<ethers.utils.BigNumber>(
		snxjs,
		'ExchangeRates',
		'rateForCurrency',
		[snxjs.toBytes32('SNX')]
